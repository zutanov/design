...
/* harmony import */ var _modules_pictureSizes__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/pictureSizes */ "./src/js/modules/pictureSizes.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_pictureSizes__WEBPACK_IMPORTED_MODULE_8__["default"])(".sizes-block");
...
var accordion = function accordion(triggersSelector, btnsSelector) {
  ...
  btns.forEach(function (el) {
    el.addEventListener("click", function () {
      if (!el.classList.contains("active")) {
        btns.forEach(function (el) {
          return el.classList.remove("active", "active-style");
        });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var burgerMenu = function burgerMenu(burgerSelector, menuSelector) {
...
var filter = function filter() {
  ...
  var showType = function showType(mark) {
...
function forms() {
  ...
  var clearInputs = function clearInputs() {
    ...
    upload.forEach(function (el) {
      return el.previousElementSibling.textContent = 'Файл не выбран';
    });
  };
  ...
  upload.forEach(function (el) {
    el.addEventListener('input', function () {
      ...
      var dots;
      var file = el.files[0].name.split('.');
      file[0].length > 6 ? dots = '...' : dots = '.';
      var name = file[0].substring(0, 6) + dots + file[1];
...
var modal = function modal() {
  ...
  openByScroll('.fixed-gift'); // modalAutoOpen('.popup-consultation', 5000);
};
...
/***/ "./src/js/modules/pictureSizes.js":
/*!****************************************!*\
  !*** ./src/js/modules/pictureSizes.js ***!
  \****************************************/
/*! exports provided: default */
...
var pictureSizes = function pictureSizes(imgSelector) {
...
/* harmony default export */ __webpack_exports__["default"] = (pictureSizes);
...
var slider = function slider(slide, dir, prev, next) {
